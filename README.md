...
Data Scientist, специализирующийся на полном цикле машинного обучения и разработке интеллектуальных систем. Экспертиза в преобразовании сложных данных в развернутые продукты с использованием Python, Scikit-learn и больших языковых моделей. Портфолио включает 10+ разнообразных ML проектов с формальным обучением в Школе 21.
...
**Программирование**  
Python, Pandas, NumPy, Matplotlib, Seaborn, C++, SQL, Объектно-ориентированное программирование (OOP)

**DevOps и Инструменты**  
Git, GitLab, Linux, Bash Scripting, Power BI, Jupyter Notebooks

**Языки**  
Персидский (Родной), Английский (C1), Турецкий (B2), Арабский (B1), Пушту (C1), Русский (B1)



### Специальные Проекты

[**Портфолио GitHub**](https://github.com/alihosseinabadi) - *2 Разнообразных ML и AI Проектов*
...
- Рост зачисление на 35% через data-driven аналитику и интеллектуальные системы
